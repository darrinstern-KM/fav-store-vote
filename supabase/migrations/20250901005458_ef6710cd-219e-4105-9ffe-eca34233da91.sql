...
-- Only allow public to view basic info through queries that don't expose sensitive data
-- This policy will be used by authenticated users and admins
...
-- Grant public access to the stores_public view
